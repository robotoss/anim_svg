...
### Phase 4 — Visibility-aware native disposal ✅
- [x] `pubspec.yaml` — `visibility_detector: ^0.4.0`
- [x] `AnimSvgView` API: `disposeWhenInvisible: bool = true`, `disposeDelay: 700ms`, `showDelay: 150ms`
...
- [x] README — "Off-screen disposal" section with tuning table and known limitations (no overlay-occlusion detection)
